...
export default function ContentArea() {
  return (
    <div>
        <p class="course-heading">Introduction of Python</p>
        ...
        <div class="course-content">
          <h2 class="sub-title">History of python</h2>
          <ul>
            <li>
              Python Programming language foundation stone laid in the year
              1980.
            </li>

            <li>
              Python Programming language implementation started in the year
              1989.
            </li>
          ...
          <h2 class="sub-title">Features of python</h2>
          <p class="content">
            Features of language are nothing Services (or) Facilities provided
            by Language developers which are used by language Programmers for
          ...
          <ol>
            ...
            <li>Embedded</li>
            <li>
              Supports Third party APIs---Numpy, Pandas, SciPy, Scikit,
              matplotlib
            </li>
          </ol>

          <h2 class="sub-title">1. Simple</h2>
          <p class="content">
            ...
            <ul>
              ...
              VARIABLES and CLASSES Examples:- math , c-math, calendar, random ,
              datetime....etc.
              <li>
              ...
              -------------------------------------------- ➢ A Garbage Collector
              is one of the in-Built Python Background which is running behind
              of Regular Python Program and whose role is to collect un-used
              memory and improves the Performance of Python Based Applications.
              ➢ hence, Garbage Collector takes about automatic Memory
              management.
              <li>
                Python Provides User-Friendly Syntaxes. So That Python
                Programmer can develop Error-Free Programs in limited span of
                time.
              </li>
            </ul>
          </p>
